...
class ControlLaw:
    ...
    def fuzzyControl(self, pub_timestep):
        ...
        if(float(pub_timestep) != float(self.timeSteps)):
        ...
        recurrent_universe = np.arange(0, 21, 1)
        ...
        difference_dictionary = ['very low', 'low', 'medium', 'high', 'very high']
        ...
        rule1 = ctrl.Rule(antecedent=(difference['very low'] & recurrence['never']), consequent=trust_algorithm['large'], label='rule1')
        rule2 = ctrl.Rule(antecedent=(difference['very low'] & recurrence['recent']), consequent=trust_algorithm['large'], label='rule2')
        rule3 = ctrl.Rule(antecedent=(difference['very low'] & recurrence['frequent']), consequent=trust_algorithm['average'], label='rule3')
        rule4 = ctrl.Rule(antecedent=(difference['low'] & recurrence['never']), consequent=trust_algorithm['large'], label='rule4')
        rule5 = ctrl.Rule(antecedent=(difference['low'] & recurrence['recent']), consequent=trust_algorithm['large'], label='rule5')
        rule6 = ctrl.Rule(antecedent=(difference['low'] & recurrence['frequent']), consequent=trust_algorithm['average'], label='rule6')
        rule7 = ctrl.Rule(antecedent=(difference['medium'] & recurrence['never']), consequent=trust_algorithm['large'], label='rule7')
        rule8 = ctrl.Rule(antecedent=(difference['medium'] & recurrence['recent']), consequent=trust_algorithm['average'], label='rule8')
        rule9 = ctrl.Rule(antecedent=(difference['medium'] & recurrence['frequent']), consequent=trust_algorithm['average'], label='rule9')
        rule10 = ctrl.Rule(antecedent=(difference['high'] & recurrence['never']), consequent=trust_algorithm['average'], label='rule10')
        rule11 = ctrl.Rule(antecedent=(difference['high'] & recurrence['recent']), consequent=trust_algorithm['small'], label='rule11')
        rule12 = ctrl.Rule(antecedent=(difference['high'] & recurrence['frequent']), consequent=trust_algorithm['small'], label='rule12')
        rule13 = ctrl.Rule(antecedent=(difference['very high'] & recurrence['never']), consequent=trust_algorithm['small'], label='rule13')
        rule14 = ctrl.Rule(antecedent=(difference['very high'] & recurrence['recent']), consequent=trust_algorithm['small'], label='rule14')
        rule15 = ctrl.Rule(antecedent=(difference['very high'] & recurrence['frequent']), consequent=trust_algorithm['small'], label='rule15')
