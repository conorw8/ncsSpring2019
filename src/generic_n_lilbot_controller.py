        ...
        for publisher in publishers.keys():
            ...
            if g_enabled:
                ...
                try:
                    ...
                    """
                    trans = tfBuffer.lookup_transform('base_link',  publisher+ "/Base Frame", rospy.Time())
                    trans_base_link_to_pose_target = tfBuffer.lookup_transform("base_link", publisher+'/desired_pose',  rospy.Time())
